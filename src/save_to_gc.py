...
blob.upload_from_filename("dataframes/italy_housing_price_rent_raw.parquet.gzip")
...
blob.upload_from_filename("dataframes/italy_housing_price_sale_raw.parquet.gzip")
